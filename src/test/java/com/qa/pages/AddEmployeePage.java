...
public class AddEmployeePage {
	 ...
	 * @param scenario
	 * 
	 *            add employee details for new employee
	 */
	...
	/**
	 * This is common method to pick all the elements in the search
	 * 
	 * @param key
	 * @param scenario
	 * @return
